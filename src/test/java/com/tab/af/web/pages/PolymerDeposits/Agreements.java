...
//       shadow.click(btn_Next, "Next");
	    ...
	    report.reportHardFail(e, "Assert Agreements Page");
	}
    }

    public Login completeAgreements() {
	try {
	    webActions.waitUntilPresentAndDisplayed(shadow.findElement(btn_ViewECD), "View ECD");
	    shadow.click(btn_ViewECD, "View ECD");
	    webActions.waitUntilPresentAndDisplayed(shadow.findElement(btn_ClosePreview),
	    ...
	    webActions.waitUntilPresentAndDisplayed(shadow.findElement(lbl_SubmitSuccess), "Submit Success").isDisplayed();
	    ...
	    report.reportHardFail(e, "Complete Agreements and Submit");
	}
