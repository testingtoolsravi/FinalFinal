...
public class BasicInformation extends BasePage {
	...
	try {
	    ...
	    report.reportHardFail(e, "Manual Entry ");
	}
    }
	...
	try {
	    ...
	    report.reportHardFail(e, "Assert Basic Information Page");
	}
    }
	...
	try {
	    ...
	    report.reportHardFail(e, "Fill Basic Info");
	}
    }

    public void driversLicenseInfo() {
	try {
	    shadow.waitUntilDisplayedAndSendKeys(txt_LicenseNumber, faker.number().digits(8), "License Number");
	    ...
	    report.reportHardFail(e, "Fill  Drivers License");
	}
    }
	...
	try {
	    ...
	    report.reportHardFail(e, "Fill Applicant Mailing Address");
	}
    }

    public void otherImportantInformation(String incomeRange, String politicallyExposedPerson,
	    String businessOrCommercialPurpose) {
	try {
	    shadow.sendKeys(txt_SecurityCodeWord, faker.number().digits(4), "Security Code word");
	    ...
	    shadow.selectRadioButonByLabel(rBtn_WillAccountBeusedFOrBusinessOrCommercialPurpose,
		    businessOrCommercialPurpose, "Will your account be used for business or commercial purposes");
	    report.reportPass("Fill Other Important Information");
	} catch (Exception e) {
	    report.reportHardFail(e, "Fill Other Important Information");
	}
    }
	...
	try {
	    ...
	    report.reportHardFail(e, "Backup WithHolding");
	}
	...
	try {
	    ...
	    shadow.sendKeys(txt_companyName, faker.company().name(), "Company Name");
	    shadow.sendKeys(txt_DoingBusinessAs, faker.random().hex(6), "Doing Business As");
	    ...
	    report.reportHardFail(e, "Legal Entity Info");
	}
    }
}