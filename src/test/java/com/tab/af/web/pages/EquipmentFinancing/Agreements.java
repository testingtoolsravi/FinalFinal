...
public class Agreements extends BasePage {
	...
	public Login completeAgreements() {
		try {
			...
			webActions.waitUntilPresentAndDisplayed(shadow.findElement(btn_ClosePreview), "Wait until Close PDF Preview Displayed");
			 ...
			 webActions.waitUntilPresentAndDisplayed(shadow.findElement(lbl_SubmitSuccess),"Submit Success") ;
