...
public class BusinessInformation extends BasePage {
	...
	try {
	    ...
	    webActions.waitUntilPresentAndDisplayed(shadow.findElement(lbl_SubmitSuccess), "Success");
	    webActions.switchToOtherOpenedWindow();
	    report.reportPass("Fill Business Information");
	} catch (Exception e) {
	    report.reportHardFail(e, "Fill Business Information");
	}
    }
	...
	try {
	    ...
	    report.reportHardFail(e, "Fill Applicant Legal Information");
	}
    }
	...
	try {
	    setApplicant(OnBoardApplicants.Applicant1, json.getIndividualMap());
	    Map<String, String> map = getApplicant(OnBoardApplicants.Applicant1);
	    ...
	    report.reportHardFail(e, "Fill Applicant Basic Information");
	}
    }
	...
	try {
	    ...
	    report.reportHardFail(e, "Fill Applicant Basic Physical Address");
	}
    }
	...
	if (getTestDataMap().get("legalEntityType").toString().equalsIgnoreCase("Sole proprietor")) {
	    ...
	    try {
		setApplicant(OnBoardApplicants.Applicant2, json.getIndividualMap());
		Map<String, String> map = getApplicant(OnBoardApplicants.Applicant2);
		...
		report.reportHardFail(e, "Fill Second Applicant Information");
	    }
	}
	...
	try {
	    ...
	    report.reportHardFail(e, "Fill Second Applicant Basic Information");
	}
    }
	...
	try {
	    ...
	    report.reportHardFail(e, "Fill Second Applicant Physical Address");
	}
    }
	...
	try {
	    ...
	    report.reportHardFail(e, " Second Applicant Mailing Address Same as Physical Address");
	}
    }
	...
	try {
	    ...
	    report.reportHardFail(e, " Second Applicant Legal Information");
	}
    }
	...
	try {
	    ...
	    report.reportHardFail(e, "Fill   Applicant Information");
	}
	return (HaulingInformation) base(HaulingInformation.class);
    }
