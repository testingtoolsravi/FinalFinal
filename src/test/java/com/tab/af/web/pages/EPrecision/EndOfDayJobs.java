...
public class EndOfDayJobs extends BasePage {
	...
	public void validateEndofDaysPageOptions() {
		try {
			...
			report.reportHardFail(e,"All End of Days Options Displayed");
		}
	}
	public void validateMessagesForAllOptions() {
		try {
			webActions.clickBYJS(btn_BalanceUpdate, "Balance Update");
			webActions.waitUntilPresentAndDisplayed(lbl_BalanceUpdateMessage, "Balance Update Message");
			webActions.clickBYJS(btn_UpdateAccounts, "Update Accounts");
			webActions.waitUntilPresentAndDisplayed(lbl_UpdateAccountsMessage, "Update Accounts Message");
			webActions.clickBYJS(btn_AddNewCards, "Add New Cards");
			webActions.waitUntilPresentAndDisplayed(lbl_AddNewCardsMessage, "Add New Cards Message");
			webActions.clickBYJS(btn_UpdateCards, "Update Cards");
			webActions.waitUntilPresentAndDisplayed(lbl_UpdateCardsMessage, "Update Cards Message");
				 
			report.reportPass("Validate Options Message ");

		} catch (Exception e) {
			report.reportHardFail(e,"Validate Options Message ");
		}
	}
}
